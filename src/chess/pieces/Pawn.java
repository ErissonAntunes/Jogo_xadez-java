...
public class Pawn extends ChessPiece {
	...
	public boolean[][] possibleMoves() {
		...
		if (getColor() == Color.WHITE) {
			...
			//#MovimentoEspecial em passant WHITE
			if (position.getRow() == 3) {
				...
				if (getBoard().positionExists(rigth) && isThereOpponentPiece(rigth) && getBoard().piece(rigth) == chessMatch.getEmPassantVulnerable()) {
			...
			//#MovimentoEspecial em passant BLACK
